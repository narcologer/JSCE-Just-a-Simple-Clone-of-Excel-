...
public class Search_frame extends javax.swing.JFrame {
    ...
    public void changetable(DefaultTableModel x,String z, Database data){
        jTable1.setModel(x);
        RowFilter<Object, Object> filter = new RowFilter<Object, Object>() {
            public boolean include (Entry e) {
                ArrayList<String> z4 = new ArrayList<String>();
                for (int i=0; i<data.columns; i++) {
                    z4.add((String) e.getValue(i));
                }
                return z4.contains(z);
            }
        };
